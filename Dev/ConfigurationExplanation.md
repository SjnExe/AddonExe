...
1.  **Version Mismatch Detected**: The addon detects it has been updated. This occurs _anytime_ the version string changes (e.g., from `1.2.4` to `1.2.5`, or during nightly development builds), ensuring all updates trigger the merge.
