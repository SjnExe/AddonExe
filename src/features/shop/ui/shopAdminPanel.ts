...
export class ShopAdminPanelHandler implements IPanelHandler {
    ...
    private async handleAddCategoryResponse(
        player: mc.Player,
    ...
    private async handleAddSubCategoryResponse(
        player: mc.Player,
        response: ModalFormResponse,
        context: UIContext
    ): Promise<void> {
    ...
    private async handleEditCategoryResponse(
        player: mc.Player,
        response: ModalFormResponse,
        context: UIContext
    ): Promise<void> {
    ...
    private async handleEditSubCategoryResponse(
        player: mc.Player,
        response: ModalFormResponse,
        context: UIContext
    ): Promise<void> {
    ...
    private async handleAddCustomItemResponse(
        player: mc.Player,
        response: ModalFormResponse,
        context: UIContext
    ): Promise<void> {
        ...
        const parent = isNonEmptyString(subName)
    ...
    private async handleAddItemFromListResponse(
        player: mc.Player,
        response: ModalFormResponse,
        context: UIContext
    ): Promise<void> {
    ...
    private async handleEditItemFormResponse(
        player: mc.Player,
        response: ModalFormResponse,
        context: UIContext
    ): Promise<void> {
    ...
    private async handleEditItemAction(
        player: mc.Player,
        panelId: string,
        item: PanelItem,
        context: UIContext
