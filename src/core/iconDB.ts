...
export const iconDB: Record<string, IconEntry> = {
    ...
    'minecraft:acacia_double_slab': { icon: 'textures/blocks/acacia_double_slab', displayName: 'Acacia Double Slab' },
    'minecraft:acacia_fence': { icon: 'textures/blocks/acacia_fence', displayName: 'Acacia Fence' },
    ...
    'minecraft:activator_rail': { icon: 'textures/items/activator_rail', displayName: 'Activator Rail' },
    'minecraft:air': { icon: 'textures/items/air', displayName: 'Air' },
    'minecraft:allium': { icon: 'textures/items/allium', displayName: 'Allium' },
    ...
    'minecraft:anvil': { icon: 'textures/blocks/anvil', displayName: 'Anvil' },
    ...
    'minecraft:bamboo_button': { icon: 'textures/blocks/bamboo_button', displayName: 'Bamboo Button' },
    'minecraft:bamboo_chest_raft': { icon: 'textures/blocks/bamboo_chest_raft', displayName: 'Bamboo Chest Raft' },
    'minecraft:bamboo_double_slab': { icon: 'textures/blocks/bamboo_double_slab', displayName: 'Bamboo Double Slab' },
    ...
    'minecraft:barrel': { icon: 'textures/items/barrel', displayName: 'Barrel' },
    'minecraft:basalt': { icon: 'textures/blocks/basalt', displayName: 'Basalt' },
    'minecraft:beacon': { icon: 'textures/blocks/beacon', displayName: 'Beacon' },
    'minecraft:bed': { icon: 'textures/items/bed', displayName: 'Bed' },
    'minecraft:bedrock': { icon: 'textures/items/bedrock', displayName: 'Bedrock' },
    'minecraft:bee_nest': { icon: 'textures/items/bee_nest', displayName: 'Bee Nest' },
    'minecraft:beehive': { icon: 'textures/items/beehive', displayName: 'Beehive' },
    'minecraft:bell': { icon: 'textures/items/bell', displayName: 'Bell' },
    'minecraft:big_dripleaf': { icon: 'textures/items/big_dripleaf', displayName: 'Big Dripleaf' },
    'minecraft:birch_boat': { icon: 'textures/items/birch_boat', displayName: 'Birch Boat' },
    'minecraft:birch_button': { icon: 'textures/blocks/birch_button', displayName: 'Birch Button' },
    'minecraft:birch_chest_boat': { icon: 'textures/items/birch_chest_boat', displayName: 'Birch Chest Boat' },
    'minecraft:birch_double_slab': { icon: 'textures/blocks/birch_double_slab', displayName: 'Birch Double Slab' },
    'minecraft:birch_fence': { icon: 'textures/blocks/birch_fence', displayName: 'Birch Fence' },
    ...
    'minecraft:birch_stairs': { icon: 'textures/blocks/birch_stairs', displayName: 'Birch Stairs' },
    'minecraft:birch_standing_sign': { icon: 'textures/items/birch_standing_sign', displayName: 'Birch Standing Sign' },
    'minecraft:birch_trapdoor': { icon: 'textures/blocks/birch_trapdoor', displayName: 'Birch Trapdoor' },
    'minecraft:birch_wall_sign': { icon: 'textures/items/birch_wall_sign', displayName: 'Birch Wall Sign' },
    'minecraft:birch_wood': { icon: 'textures/blocks/birch_wood', displayName: 'Birch Wood' },
    'minecraft:black_candle': { icon: 'textures/items/black_candle', displayName: 'Black Candle' },
    ...
    'minecraft:blast_furnace': { icon: 'textures/blocks/blast_furnace', displayName: 'Blast Furnace' },
    'minecraft:blue_candle': { icon: 'textures/items/blue_candle', displayName: 'Blue Candle' },
    ...
    'minecraft:brick_stairs': { icon: 'textures/items/brick_stairs', displayName: 'Brick Stairs' },
    'minecraft:brick_wall': { icon: 'textures/items/brick_wall', displayName: 'Brick Wall' },
    'minecraft:brown_candle': { icon: 'textures/items/brown_candle', displayName: 'Brown Candle' },
    ...
    'minecraft:carrots': { icon: 'textures/items/carrots', displayName: 'Carrots' },
    ...
    'minecraft:cherry_button': { icon: 'textures/blocks/cherry_button', displayName: 'Cherry Button' },
    'minecraft:cherry_chest_boat': { icon: 'textures/items/cherry_chest_boat', displayName: 'Cherry Chest Boat' },
    'minecraft:cherry_double_slab': { icon: 'textures/blocks/cherry_double_slab', displayName: 'Cherry Double Slab' },
    'minecraft:cherry_fence': { icon: 'textures/blocks/cherry_fence', displayName: 'Cherry Fence' },
    ...
    'minecraft:chest': { icon: 'textures/blocks/chest', displayName: 'Chest' },
    'minecraft:chest_boat': { icon: 'textures/items/chest_boat', displayName: 'Chest Boat' },
    'minecraft:chipped_anvil': { icon: 'textures/blocks/chipped_anvil', displayName: 'Chipped Anvil' },
    ...
    'minecraft:closed_eyeblossom': { icon: 'textures/items/closed_eyeblossom', displayName: 'Closed Eyeblossom' },
    'minecraft:coal_block': { icon: 'textures/items/coal_block', displayName: 'Coal Block' },
    ...
    'minecraft:concrete_powder': { icon: 'textures/items/concrete_powder', displayName: 'Concrete Powder' },
    'minecraft:conduit': { icon: 'textures/blocks/conduit', displayName: 'Conduit' },
    'minecraft:cooked_chicken': { icon: 'textures/items/cooked_chicken', displayName: 'Cooked Chicken' },
    'minecraft:cooked_mutton': { icon: 'textures/items/cooked_mutton', displayName: 'Cooked Mutton' },
    'minecraft:cooked_rabbit': { icon: 'textures/items/cooked_rabbit', displayName: 'Cooked Rabbit' },
    'minecraft:copper_axe': { icon: 'textures/items/copper_axe', displayName: 'Copper Axe' },
    'minecraft:copper_bars': { icon: 'textures/items/copper_bars', displayName: 'Copper Bars' },
    'minecraft:copper_block': { icon: 'textures/blocks/copper_block', displayName: 'Copper Block' },
    'minecraft:copper_boots': { icon: 'textures/items/copper_boots', displayName: 'Copper Boots' },
    'minecraft:copper_bulb': { icon: 'textures/items/copper_bulb', displayName: 'Copper Bulb' },
    ...
    'minecraft:copper_hoe': { icon: 'textures/items/copper_hoe', displayName: 'Copper Hoe' },
    'minecraft:copper_horse_armor': { icon: 'textures/items/copper_horse_armor', displayName: 'Copper Horse Armor' },
    'minecraft:copper_lantern': { icon: 'textures/blocks/copper_lantern', displayName: 'Copper Lantern' },
    'minecraft:copper_leggings': { icon: 'textures/items/copper_leggings', displayName: 'Copper Leggings' },
    'minecraft:copper_nugget': { icon: 'textures/items/copper_nugget', displayName: 'Copper Nugget' },
    'minecraft:copper_ore': { icon: 'textures/blocks/copper_ore', displayName: 'Copper Ore' },
    'minecraft:copper_pickaxe': { icon: 'textures/items/copper_pickaxe', displayName: 'Copper Pickaxe' },
    'minecraft:copper_shovel': { icon: 'textures/items/copper_shovel', displayName: 'Copper Shovel' },
    'minecraft:copper_sword': { icon: 'textures/items/copper_sword', displayName: 'Copper Sword' },
    'minecraft:copper_torch': { icon: 'textures/blocks/copper_torch', displayName: 'Copper Torch' },
    'minecraft:copper_trapdoor': { icon: 'textures/blocks/copper_trapdoor', displayName: 'Copper Trapdoor' },
    'minecraft:coral': { icon: 'textures/blocks/coral', displayName: 'Coral' },
    'minecraft:coral_block': { icon: 'textures/blocks/coral_block', displayName: 'Coral Block' },
    ...
    'minecraft:cut_copper': { icon: 'textures/items/cut_copper', displayName: 'Cut Copper' },
    ...
    'minecraft:dandelion': { icon: 'textures/items/dandelion', displayName: 'Dandelion' },
    ...
    'minecraft:dark_oak_stairs': { icon: 'textures/blocks/dark_oak_stairs', displayName: 'Dark Oak Stairs' },
    ...
    'minecraft:dripstone_block': { icon: 'textures/blocks/dripstone_block', displayName: 'Dripstone Block' },
    'minecraft:dropper': { icon: 'textures/blocks/dropper', displayName: 'Dropper' },
    'minecraft:dye': { icon: 'textures/items/dye', displayName: 'Dye' },
    'minecraft:emerald_block': { icon: 'textures/blocks/emerald_block', displayName: 'Emerald Block' },
    'minecraft:emerald_ore': { icon: 'textures/blocks/emerald_ore', displayName: 'Emerald Ore' },
    'minecraft:empty_map': { icon: 'textures/items/empty_map', displayName: 'Empty Map' },
    'minecraft:enchanting_table': { icon: 'textures/blocks/enchanting_table', displayName: 'Enchanting Table' },
    ...
    'minecraft:flowering_azalea': { icon: 'textures/items/flowering_azalea', displayName: 'Flowering Azalea' },
    'minecraft:flowing_lava': { icon: 'textures/items/flowing_lava', displayName: 'Flowing Lava' },
    'minecraft:flowing_water': { icon: 'textures/items/flowing_water', displayName: 'Flowing Water' },
    'minecraft:frame': { icon: 'textures/items/frame', displayName: 'Frame' },
    'minecraft:frog_spawn': { icon: 'textures/items/frog_spawn', displayName: 'Frog Spawn' },
    'minecraft:frosted_ice': { icon: 'textures/blocks/frosted_ice', displayName: 'Frosted Ice' },
    'minecraft:furnace': { icon: 'textures/blocks/furnace', displayName: 'Furnace' },
    'minecraft:gilded_blackstone': { icon: 'textures/blocks/gilded_blackstone', displayName: 'Gilded Blackstone' },
    'minecraft:glass_pane': { icon: 'textures/blocks/glass_pane', displayName: 'Glass Pane' },
    'minecraft:glow_frame': { icon: 'textures/items/glow_frame', displayName: 'Glow Frame' },
    'minecraft:glow_ink_sac': { icon: 'textures/items/glow_ink_sac', displayName: 'Glow Ink Sac' },
    'minecraft:glow_lichen': { icon: 'textures/items/glow_lichen', displayName: 'Glow Lichen' },
    'minecraft:glow_stick': { icon: 'textures/items/glow_stick', displayName: 'Glow Stick' },
    'minecraft:gold_block': { icon: 'textures/blocks/gold_block', displayName: 'Gold Block' },
    'minecraft:gold_ore': { icon: 'textures/blocks/gold_ore', displayName: 'Gold Ore' },
    'minecraft:golden_apple': { icon: 'textures/items/golden_apple', displayName: 'Golden Apple' },
    'minecraft:golden_axe': { icon: 'textures/items/golden_axe', displayName: 'Golden Axe' },
    'minecraft:golden_boots': { icon: 'textures/items/golden_boots', displayName: 'Golden Boots' },
    'minecraft:golden_chestplate': { icon: 'textures/items/golden_chestplate', displayName: 'Golden Chestplate' },
    'minecraft:golden_helmet': { icon: 'textures/items/golden_helmet', displayName: 'Golden Helmet' },
    'minecraft:golden_hoe': { icon: 'textures/items/golden_hoe', displayName: 'Golden Hoe' },
    'minecraft:golden_horse_armor': { icon: 'textures/items/golden_horse_armor', displayName: 'Golden Horse Armor' },
    'minecraft:golden_leggings': { icon: 'textures/items/golden_leggings', displayName: 'Golden Leggings' },
    'minecraft:golden_pickaxe': { icon: 'textures/items/golden_pickaxe', displayName: 'Golden Pickaxe' },
    'minecraft:golden_rail': { icon: 'textures/items/golden_rail', displayName: 'Golden Rail' },
    ...
    'minecraft:grass_block': { icon: 'textures/blocks/grass_block', displayName: 'Grass Block' },
    'minecraft:grass_path': { icon: 'textures/blocks/grass_path', displayName: 'Grass Path' },
    'minecraft:gray_candle': { icon: 'textures/items/gray_candle', displayName: 'Gray Candle' },
    ...
    'minecraft:iron_bars': { icon: 'textures/items/iron_bars', displayName: 'Iron Bars' },
    'minecraft:iron_block': { icon: 'textures/blocks/iron_block', displayName: 'Iron Block' },
    'minecraft:iron_boots': { icon: 'textures/items/iron_boots', displayName: 'Iron Boots' },
    'minecraft:iron_chain': { icon: 'textures/items/iron_chain', displayName: 'Iron Chain' },
    'minecraft:iron_chestplate': { icon: 'textures/items/iron_chestplate', displayName: 'Iron Chestplate' },
    'minecraft:iron_helmet': { icon: 'textures/items/iron_helmet', displayName: 'Iron Helmet' },
    'minecraft:iron_hoe': { icon: 'textures/items/iron_hoe', displayName: 'Iron Hoe' },
    'minecraft:iron_leggings': { icon: 'textures/items/iron_leggings', displayName: 'Iron Leggings' },
    'minecraft:iron_ore': { icon: 'textures/blocks/iron_ore', displayName: 'Iron Ore' },
    'minecraft:iron_pickaxe': { icon: 'textures/items/iron_pickaxe', displayName: 'Iron Pickaxe' },
    'minecraft:iron_shovel': { icon: 'textures/items/iron_shovel', displayName: 'Iron Shovel' },
    'minecraft:iron_sword': { icon: 'textures/items/iron_sword', displayName: 'Iron Sword' },
    'minecraft:iron_trapdoor': { icon: 'textures/blocks/iron_trapdoor', displayName: 'Iron Trapdoor' },
    'minecraft:jukebox': { icon: 'textures/blocks/jukebox', displayName: 'Jukebox' },
    'minecraft:jungle_boat': { icon: 'textures/items/jungle_boat', displayName: 'Jungle Boat' },
    'minecraft:jungle_button': { icon: 'textures/blocks/jungle_button', displayName: 'Jungle Button' },
    'minecraft:jungle_chest_boat': { icon: 'textures/items/jungle_chest_boat', displayName: 'Jungle Chest Boat' },
    'minecraft:jungle_double_slab': { icon: 'textures/blocks/jungle_double_slab', displayName: 'Jungle Double Slab' },
    'minecraft:jungle_fence': { icon: 'textures/blocks/jungle_fence', displayName: 'Jungle Fence' },
    ...
    'minecraft:ladder': { icon: 'textures/blocks/ladder', displayName: 'Ladder' },
    'minecraft:lantern': { icon: 'textures/blocks/lantern', displayName: 'Lantern' },
    'minecraft:lapis_block': { icon: 'textures/blocks/lapis_block', displayName: 'Lapis Block' },
    'minecraft:lapis_ore': { icon: 'textures/blocks/lapis_ore', displayName: 'Lapis Ore' },
    'minecraft:large_amethyst_bud': { icon: 'textures/items/large_amethyst_bud', displayName: 'Large Amethyst Bud' },
    'minecraft:large_fern': { icon: 'textures/items/large_fern', displayName: 'Large Fern' },
    'minecraft:lava': { icon: 'textures/items/lava', displayName: 'Lava' },
    'minecraft:lava_bucket': { icon: 'textures/items/lava_bucket', displayName: 'Lava Bucket' },
    'minecraft:leaf_litter': { icon: 'textures/items/leaf_litter', displayName: 'Leaf Litter' },
    'minecraft:leather_boots': { icon: 'textures/items/leather_boots', displayName: 'Leather Boots' },
    'minecraft:leather_chestplate': { icon: 'textures/items/leather_chestplate', displayName: 'Leather Chestplate' },
    'minecraft:leather_helmet': { icon: 'textures/items/leather_helmet', displayName: 'Leather Helmet' },
    'minecraft:leather_leggings': { icon: 'textures/items/leather_leggings', displayName: 'Leather Leggings' },
    'minecraft:leaves': { icon: 'textures/blocks/leaves', displayName: 'Leaves' },
    ...
    'minecraft:lime_candle': { icon: 'textures/items/lime_candle', displayName: 'Lime Candle' },
    ...
    'minecraft:lit_redstone_ore': { icon: 'textures/blocks/lit_redstone_ore', displayName: 'Lit Redstone Ore' },
    'minecraft:lit_smoker': { icon: 'textures/blocks/lit_smoker', displayName: 'Lit Smoker' },
    'minecraft:lodestone': { icon: 'textures/blocks/lodestone', displayName: 'Lodestone' },
    'minecraft:log': { icon: 'textures/blocks/log', displayName: 'Log' },
    'minecraft:log2': { icon: 'textures/blocks/log2', displayName: 'Log2' },
    'minecraft:loom': { icon: 'textures/blocks/loom', displayName: 'Loom' },
    'minecraft:mace': { icon: 'textures/items/mace', displayName: 'Mace' },
    'minecraft:magenta_candle': { icon: 'textures/items/magenta_candle', displayName: 'Magenta Candle' },
    ...
    'minecraft:mangrove_boat': { icon: 'textures/items/mangrove_boat', displayName: 'Mangrove Boat' },
    ...
    'minecraft:medium_amethyst_bud': { icon: 'textures/items/medium_amethyst_bud', displayName: 'Medium Amethyst Bud' },
    'minecraft:melon_block': { icon: 'textures/blocks/melon_block', displayName: 'Melon Block' },
    'minecraft:melon_stem': { icon: 'textures/blocks/melon_stem_top', displayName: 'Melon Stem' },
    'minecraft:milk_bucket': { icon: 'textures/items/milk_bucket', displayName: 'Milk Bucket' },
    ...
    'minecraft:nether_brick_wall': { icon: 'textures/items/nether_brick_wall', displayName: 'Nether Brick Wall' },
    'minecraft:nether_gold_ore': { icon: 'textures/blocks/nether_gold_ore', displayName: 'Nether Gold Ore' },
    'minecraft:nether_wart_block': { icon: 'textures/blocks/nether_wart_block', displayName: 'Nether Wart Block' },
    'minecraft:netherbrick': { icon: 'textures/items/netherbrick', displayName: 'Netherbrick' },
    'minecraft:netherite_axe': { icon: 'textures/items/netherite_axe', displayName: 'Netherite Axe' },
    ...
    'minecraft:oak_double_slab': { icon: 'textures/blocks/oak_double_slab', displayName: 'Oak Double Slab' },
    'minecraft:oak_fence': { icon: 'textures/blocks/oak_fence', displayName: 'Oak Fence' },
    'minecraft:oak_leaves': { icon: 'textures/blocks/oak_leaves', displayName: 'Oak Leaves' },
    'minecraft:oak_planks': { icon: 'textures/blocks/oak_planks', displayName: 'Oak Planks' },
    'minecraft:oak_sapling': { icon: 'textures/blocks/oak_sapling', displayName: 'Oak Sapling' },
    'minecraft:oak_shelf': { icon: 'textures/items/oak_shelf', displayName: 'Oak Shelf' },
    'minecraft:oak_slab': { icon: 'textures/blocks/oak_slab', displayName: 'Oak Slab' },
    'minecraft:oak_stairs': { icon: 'textures/blocks/oak_stairs', displayName: 'Oak Stairs' },
    'minecraft:oak_wood': { icon: 'textures/blocks/oak_wood', displayName: 'Oak Wood' },
    'minecraft:observer': { icon: 'textures/blocks/observer', displayName: 'Observer' },
    'minecraft:ochre_froglight': { icon: 'textures/items/ochre_froglight', displayName: 'Ochre Froglight' },
    'minecraft:open_eyeblossom': { icon: 'textures/items/open_eyeblossom', displayName: 'Open Eyeblossom' },
    'minecraft:orange_candle': { icon: 'textures/items/orange_candle', displayName: 'Orange Candle' },
    ...
    'minecraft:pale_moss_block': { icon: 'textures/blocks/pale_moss_block', displayName: 'Pale Moss Block' },
    'minecraft:pale_moss_carpet': { icon: 'textures/items/pale_moss_carpet', displayName: 'Pale Moss Carpet' },
    'minecraft:pale_oak_boat': { icon: 'textures/items/pale_oak_boat', displayName: 'Pale Oak Boat' },
    ...
    'minecraft:powder_snow': { icon: 'textures/items/powder_snow', displayName: 'Powder Snow' },
    'minecraft:powder_snow_bucket': { icon: 'textures/items/powder_snow_bucket', displayName: 'Powder Snow Bucket' },
    ...
    'minecraft:pufferfish_bucket': { icon: 'textures/items/pufferfish_bucket', displayName: 'Pufferfish Bucket' },
    'minecraft:pumpkin_stem': { icon: 'textures/blocks/pumpkin_stem_top', displayName: 'Pumpkin Stem' },
    'minecraft:purple_candle': { icon: 'textures/items/purple_candle', displayName: 'Purple Candle' },
    ...
    'minecraft:purpur_pillar': { icon: 'textures/items/purpur_pillar', displayName: 'Purpur Pillar' },
    'minecraft:purpur_slab': { icon: 'textures/blocks/purpur_slab', displayName: 'Purpur Slab' },
    'minecraft:purpur_stairs': { icon: 'textures/blocks/purpur_stairs', displayName: 'Purpur Stairs' },
    'minecraft:quartz_block': { icon: 'textures/blocks/quartz_block', displayName: 'Quartz Block' },
    'minecraft:quartz_bricks': { icon: 'textures/items/quartz_bricks', displayName: 'Quartz Bricks' },
    'minecraft:quartz_double_slab': { icon: 'textures/blocks/quartz_double_slab', displayName: 'Quartz Double Slab' },
    'minecraft:quartz_ore': { icon: 'textures/blocks/quartz_ore', displayName: 'Quartz Ore' },
    'minecraft:quartz_pillar': { icon: 'textures/items/quartz_pillar', displayName: 'Quartz Pillar' },
    'minecraft:quartz_slab': { icon: 'textures/blocks/quartz_slab', displayName: 'Quartz Slab' },
    'minecraft:quartz_stairs': { icon: 'textures/blocks/quartz_stairs', displayName: 'Quartz Stairs' },
    'minecraft:rabbit': { icon: 'textures/items/rabbit', displayName: 'Rabbit' },
    'minecraft:rail': { icon: 'textures/items/rail', displayName: 'Rail' },
    'minecraft:raw_copper_block': { icon: 'textures/blocks/raw_copper_block', displayName: 'Raw Copper Block' },
    'minecraft:raw_gold_block': { icon: 'textures/blocks/raw_gold_block', displayName: 'Raw Gold Block' },
    'minecraft:raw_iron_block': { icon: 'textures/blocks/raw_iron_block', displayName: 'Raw Iron Block' },
    'minecraft:red_candle': { icon: 'textures/items/red_candle', displayName: 'Red Candle' },
    'minecraft:red_candle_cake': { icon: 'textures/items/red_candle_cake', displayName: 'Red Candle Cake' },
    'minecraft:red_carpet': { icon: 'textures/items/red_carpet', displayName: 'Red Carpet' },
    'minecraft:red_concrete': { icon: 'textures/blocks/red_concrete', displayName: 'Red Concrete' },
    ...
    'minecraft:redstone_block': { icon: 'textures/blocks/redstone_block', displayName: 'Redstone Block' },
    'minecraft:redstone_lamp': { icon: 'textures/blocks/redstone_lamp', displayName: 'Redstone Lamp' },
    ...
    'minecraft:sapling': { icon: 'textures/blocks/sapling', displayName: 'Sapling' },
    'minecraft:scaffolding': { icon: 'textures/blocks/scaffolding', displayName: 'Scaffolding' },
    'minecraft:sculk': { icon: 'textures/items/sculk', displayName: 'Sculk' },
    'minecraft:sculk_catalyst': { icon: 'textures/items/sculk_catalyst', displayName: 'Sculk Catalyst' },
    'minecraft:sculk_sensor': { icon: 'textures/items/sculk_sensor', displayName: 'Sculk Sensor' },
    'minecraft:sculk_shrieker': { icon: 'textures/items/sculk_shrieker', displayName: 'Sculk Shrieker' },
    'minecraft:sculk_vein': { icon: 'textures/items/sculk_vein', displayName: 'Sculk Vein' },
    'minecraft:sea_lantern': { icon: 'textures/blocks/sea_lantern', displayName: 'Sea Lantern' },
    'minecraft:sea_pickle': { icon: 'textures/items/sea_pickle', displayName: 'Sea Pickle' },
    'minecraft:seagrass': { icon: 'textures/items/seagrass', displayName: 'Seagrass' },
    'minecraft:shield': { icon: 'textures/items/shield', displayName: 'Shield' },
    'minecraft:short_dry_grass': { icon: 'textures/items/short_dry_grass', displayName: 'Short Dry Grass' },
    ...
    'minecraft:snow_layer': { icon: 'textures/blocks/snow_layer', displayName: 'Snow Layer' },
    'minecraft:soul_fire': { icon: 'textures/items/soul_fire', displayName: 'Soul Fire' },
    'minecraft:soul_lantern': { icon: 'textures/blocks/soul_lantern', displayName: 'Soul Lantern' },
    'minecraft:soul_sand': { icon: 'textures/blocks/soul_sand', displayName: 'Soul Sand' },
    'minecraft:soul_soil': { icon: 'textures/items/soul_soil', displayName: 'Soul Soil' },
    'minecraft:soul_torch': { icon: 'textures/blocks/soul_torch', displayName: 'Soul Torch' },
    'minecraft:sponge': { icon: 'textures/items/sponge', displayName: 'Sponge' },
    'minecraft:spore_blossom': { icon: 'textures/blocks/spore_blossom', displayName: 'Spore Blossom' },
    'minecraft:spruce_boat': { icon: 'textures/items/spruce_boat', displayName: 'Spruce Boat' },
    'minecraft:spruce_button': { icon: 'textures/blocks/spruce_button', displayName: 'Spruce Button' },
    'minecraft:spruce_chest_boat': { icon: 'textures/items/spruce_chest_boat', displayName: 'Spruce Chest Boat' },
    'minecraft:spruce_double_slab': { icon: 'textures/blocks/spruce_double_slab', displayName: 'Spruce Double Slab' },
    'minecraft:spruce_fence': { icon: 'textures/blocks/spruce_fence', displayName: 'Spruce Fence' },
    ...
    'minecraft:sweet_berry_bush': { icon: 'textures/items/sweet_berry_bush', displayName: 'Sweet Berry Bush' },
    'minecraft:tadpole_bucket': { icon: 'textures/items/tadpole_bucket', displayName: 'Tadpole Bucket' },
    'minecraft:tall_dry_grass': { icon: 'textures/items/tall_dry_grass', displayName: 'Tall Dry Grass' },
    'minecraft:tall_grass': { icon: 'textures/items/tall_grass', displayName: 'Tall Grass' },
    'minecraft:tallgrass': { icon: 'textures/items/tallgrass', displayName: 'Tallgrass' },
    'minecraft:target': { icon: 'textures/items/target', displayName: 'Target' },
    'minecraft:tinted_glass': { icon: 'textures/blocks/tinted_glass', displayName: 'Tinted Glass' },
    'minecraft:tnt': { icon: 'textures/items/tnt', displayName: 'Tnt' },
    'minecraft:torch': { icon: 'textures/blocks/torch', displayName: 'Torch' },
    'minecraft:torchflower': { icon: 'textures/blocks/torchflower', displayName: 'Torchflower' },
    'minecraft:torchflower_crop': { icon: 'textures/blocks/torchflower_crop', displayName: 'Torchflower Crop' },
    'minecraft:trapdoor': { icon: 'textures/blocks/trapdoor', displayName: 'Trapdoor' },
    'minecraft:trapped_chest': { icon: 'textures/blocks/trapped_chest', displayName: 'Trapped Chest' },
    ...
    'minecraft:tuff_bricks': { icon: 'textures/items/tuff_bricks', displayName: 'Tuff Bricks' },
    'minecraft:tuff_double_slab': { icon: 'textures/blocks/tuff_double_slab', displayName: 'Tuff Double Slab' },
    'minecraft:tuff_slab': { icon: 'textures/blocks/tuff_slab', displayName: 'Tuff Slab' },
    'minecraft:tuff_stairs': { icon: 'textures/blocks/tuff_stairs', displayName: 'Tuff Stairs' },
    'minecraft:tuff_wall': { icon: 'textures/blocks/tuff_wall', displayName: 'Tuff Wall' },
    'minecraft:turtle_egg': { icon: 'textures/items/turtle_egg', displayName: 'Turtle Egg' },
    ...
    'minecraft:warped_fence': { icon: 'textures/blocks/warped_fence', displayName: 'Warped Fence' },
    'minecraft:warped_fence_gate': { icon: 'textures/blocks/warped_fence_gate', displayName: 'Warped Fence Gate' },
    'minecraft:warped_fungus': { icon: 'textures/blocks/warped_fungus', displayName: 'Warped Fungus' },
    ...
    'minecraft:wildflowers': { icon: 'textures/items/wildflowers', displayName: 'Wildflowers' },
    'minecraft:wither_rose': { icon: 'textures/items/wither_rose', displayName: 'Wither Rose' },
    'minecraft:wood': { icon: 'textures/blocks/wood', displayName: 'Wood' },
    'minecraft:wooden_axe': { icon: 'textures/items/wooden_axe', displayName: 'Wooden Axe' },
    'minecraft:wooden_button': { icon: 'textures/blocks/wooden_button', displayName: 'Wooden Button' },
    ...
    'minecraft:wool': { icon: 'textures/items/wool', displayName: 'Wool' },
    'minecraft:yellow_candle': { icon: 'textures/items/yellow_candle', displayName: 'Yellow Candle' },
