...
describe('timerManager', () => {
    beforeEach(() => {
        ...
        if ((mc.system.runTimeout as any) && (mc.system.runTimeout as any).mockClear) {
            (mc.system.runTimeout as any).mockClear();
        }
        if ((mc.system.runJob as any) && (mc.system.runJob as any).mockClear) {
            (mc.system.runJob as any).mockClear();
        }
        if ((mc.system.clearRun as any).mockClear) {
            (mc.system.clearRun as any).mockClear();
        }
