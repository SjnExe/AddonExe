...
describe('PunishmentManager', () => {
    ...
    it('should add and retrieve a ban', () => {
        const pid = '123';
        const ban = { type: 'ban' as const, expires: Date.now() + 10000, reason: 'test' };
    ...
    it('should support concurrent ban and mute', () => {
        const pid = '456';
        const ban = { type: 'ban' as const, expires: Date.now() + 10000, reason: 'banned' };
        const mute = { type: 'mute' as const, expires: Date.now() + 10000, reason: 'muted' };
