    ...
    try {
        ...
        if (panelId === 'floatingTextEditPanel') {
            ...
            const form = new ModalFormData()
                ...
                .textField('X Coordinate', 'Enter the X coordinate', { defaultValue: String(+(text.location?.x ?? 0).toFixed(3)) })
                .textField('Y Coordinate', 'Enter the Y coordinate', { defaultValue: String(+(text.location?.y ?? 0).toFixed(3)) })
                .textField('Z Coordinate', 'Enter the Z coordinate', { defaultValue: String(+(text.location?.z ?? 0).toFixed(3)) })
