...
export default defineConfig({
    test: {
        ...
        alias: {
            ...
            './core/ranksConfig.js': path.resolve(__dirname, 'src/core/ranksConfig.ts'),
            './core/spawnConfig.js': path.resolve(__dirname, 'src/core/spawnConfig.ts'),
            './core/sidebarConfig.js': path.resolve(__dirname, 'src/core/sidebarConfig.ts'),
            './core/xrayConfig.js': path.resolve(__dirname, 'src/core/xrayConfig.ts'),
            './features/kits/kitsConfig.js': path.resolve(__dirname, 'src/features/kits/kitsConfig.ts'),
            './features/economy/economyConfig.js': path.resolve(__dirname, 'src/features/economy/economyConfig.ts'),
            './features/auctionHouse/auctionHouseConfig.js': path.resolve(__dirname, 'src/features/auctionHouse/auctionHouseConfig.ts'),
            './features/dailyRewards/dailyRewardsConfig.js': path.resolve(__dirname, 'src/features/dailyRewards/dailyRewardsConfig.ts'),
            './features/games/gamesConfig.js': path.resolve(__dirname, 'src/features/games/gamesConfig.ts'),
            ...
            './core/itemsConfig.js': path.resolve(__dirname, 'src/core/itemsConfig.ts'),
