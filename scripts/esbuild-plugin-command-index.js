    ...
    setup(build) {
        build.onLoad({ filter: /src[\\/]core[\\/]commands[\\/]index\.ts$/ }, async () => {
            ...
            try {
                ...
                // Use a simple regex to match the feature IDs generated by generate-feature-registry.js
                // Matches lines like: { id: 'anticheat', load: ... }
                ...
                console.warn(`Error reading src/core/featureRegistry.ts: ${error.message}. Make sure generate-feature-registry.js ran before build.`);
            }
